...
export const APP_VERSION = 'v2.6.47923';
export const APP_BUILD_NUMBER = 1787923735522;
export const APP_BUILD_DATE = '28/08/2026';
export const APP_BUILD_TIME = '09:28:55';
export const APP_RELEASE_TIMESTAMP = 1787923735522;
export const APP_RELEASE_NAME = 'GoField Pro Tactical v2.6.47923';
