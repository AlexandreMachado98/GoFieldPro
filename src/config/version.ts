...
export const APP_VERSION = 'v2.6.48262';
export const APP_BUILD_NUMBER = 1788262336308;
export const APP_BUILD_DATE = '01/09/2026';
export const APP_BUILD_TIME = '07:32:16';
export const APP_RELEASE_TIMESTAMP = 1788262336308;
export const APP_RELEASE_NAME = 'GoField Pro Tactical v2.6.48262';
