...
export const APP_VERSION = 'v2.6.47941';
export const APP_BUILD_NUMBER = 1787941623163;
export const APP_BUILD_DATE = '28/08/2026';
export const APP_BUILD_TIME = '14:27:03';
export const APP_RELEASE_TIMESTAMP = 1787941623163;
export const APP_RELEASE_NAME = 'GoField Pro Tactical v2.6.47941';
