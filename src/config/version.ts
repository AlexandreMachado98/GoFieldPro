...
export const APP_VERSION = 'v2.6.48263';
export const APP_BUILD_NUMBER = 1788263136805;
export const APP_BUILD_DATE = '01/09/2026';
export const APP_BUILD_TIME = '07:45:36';
export const APP_RELEASE_TIMESTAMP = 1788263136805;
export const APP_RELEASE_NAME = 'GoField Pro Tactical v2.6.48263';
