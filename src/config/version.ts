...
export const APP_VERSION = 'v2.6.47956';
export const APP_BUILD_NUMBER = 1787956074901;
export const APP_BUILD_DATE = '28/08/2026';
export const APP_BUILD_TIME = '18:27:54';
export const APP_RELEASE_TIMESTAMP = 1787956074901;
export const APP_RELEASE_NAME = 'GoField Pro Tactical v2.6.47956';
