...
export const APP_VERSION = 'v2.6.47920';
export const APP_BUILD_NUMBER = 1787920970366;
export const APP_BUILD_DATE = '28/08/2026';
export const APP_BUILD_TIME = '08:42:50';
export const APP_RELEASE_TIMESTAMP = 1787920970366;
export const APP_RELEASE_NAME = 'GoField Pro Tactical v2.6.47920';
