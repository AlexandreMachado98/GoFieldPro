...
export const APP_VERSION = 'v2.6.48265';
export const APP_BUILD_NUMBER = 1788265953416;
export const APP_BUILD_DATE = '01/09/2026';
export const APP_BUILD_TIME = '08:32:33';
export const APP_RELEASE_TIMESTAMP = 1788265953416;
export const APP_RELEASE_NAME = 'GoField Pro Tactical v2.6.48265';
