...
export const APP_VERSION = 'v2.6.48313';
export const APP_BUILD_NUMBER = 1788313532785;
export const APP_BUILD_DATE = '01/09/2026';
export const APP_BUILD_TIME = '21:45:32';
export const APP_RELEASE_TIMESTAMP = 1788313532785;
export const APP_RELEASE_NAME = 'GoField Pro Tactical v2.6.48313';
