...
export const APP_VERSION = 'v2.6.47939';
export const APP_BUILD_NUMBER = 1787939905957;
export const APP_BUILD_DATE = '28/08/2026';
export const APP_BUILD_TIME = '13:58:25';
export const APP_RELEASE_TIMESTAMP = 1787939905957;
export const APP_RELEASE_NAME = 'GoField Pro Tactical v2.6.47939';
